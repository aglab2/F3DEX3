...
vClFade2 equ $v2
    ...
    */
    ...
    vmudh   $v29, $v29, $v30[0]              // elem 0 is (1 or -1) * 2 (clip ratio)
...
// sSCF is $v20 // vtx_store Scaled Clipping Frac
    vmudn   sSCF, vPairTPosF, $v30[0]        // W * clip ratio for scaled clipping
    ssv     sCLZ[12], (VTX_SCR_Z      )(secondVtxPos)
// sSCI is $v21 // vtx_store Scaled Clipping Int
    vmadh   sSCI, vPairTPosI, $v30[0]        // W * clip ratio for scaled clipping
